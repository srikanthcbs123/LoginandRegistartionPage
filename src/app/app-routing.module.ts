...
const routes: Routes = [
  //each route is one page(for each page implementation for we need to create one component)
  ...
  { path: 'home/:UserName', component: HomeComponent }, //synatx:{ path: "pathname/:parametername", component: ComponentClassname }
  {
    path: 'user',
    component: UserComponent, //Here user is a parent route.and it contains below children pages/Routes.
    children: [
      //children routes creation  for we used childern array here.
